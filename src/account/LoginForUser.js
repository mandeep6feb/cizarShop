    ...
    <div className="App-header">
      <Card className="Card_outer">
        <Card.Body>
          ...
          <Form>
            <Form.Group
              className="mb-3 login_heading-sub"
              controlId="formBasicEmail"
            >
              <Form.Label className="login_heading-sub-1">
                Email address
              </Form.Label>
              <Form.Control
                className="login_heading-sub-1-2"
                type="email"
            ...
            <div>
                <h6>if you are not registered <a href="/register">click here</a></h6>
            </div>
          </Form>
        </Card.Body>
      </Card>
